 ...
 * @author 杨拔纲
 */
public class XYMain2Activity extends SubActivity {
    ...
    public void xyOperation(View view) {
        ...
        if (xyModel == null && BTStatus.BT_BUTTONS[BTStatus.BT_STATU_NOT_ASSIGN].equals(operator)) {
            // 还未绑定，开始绑定过程
            Intent intent = new Intent(XYMain2Activity.this,
        ...
        boolean hasRight = ybgApp.checkPermission(XYMain2Activity.this, Manifest.permission
        ...
        if (hasRight && (urionService != null) || (xyUrionService != null)) {
            ...
            // 启动进度条
            readProgressDialog = ybgApp.getProgressDialog(XYMain2Activity.this,
                    "正在测量...");
    ...
    protected void onStart() {
        ...
        if (bluetoothAdapter == null) {
            ...
            // 开启后台程序
            Intent intent = new Intent(XYMain2Activity.this, UrionService.class);
            getApplication().bindService(intent, urionConnection, Context.BIND_AUTO_CREATE);
            Intent intent2 = new Intent(XYMain2Activity.this, XYUrionService.class);
        ...
        bindIntent = new Intent(XYMain2Activity.this, XYDataService.class);
