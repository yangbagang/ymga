 ...
 *
 */
public class XYHistorySearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.xy_history_search);
		
		beginDateView = (EditText) findViewById(R.id.xyHistorySearchBegin);
		endDateView = (EditText) findViewById(R.id.xyHistorySearchEnd);
		...
		beginDateView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new DatePickerDialog(XYHistorySearchActivity.this, beginDateListener,
		...
		endDateView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				new DatePickerDialog(XYHistorySearchActivity.this, endDateListener,
						calendar.get(Calendar.YEAR), calendar
								.get(Calendar.MONTH), calendar
								.get(Calendar.DAY_OF_MONTH)).show();
			}
	...
	public void beginSearch(View view) {
		...
		setResult(AppConstat.XY_SEARCH_RESULT_CODE, intent);
		finish();
	}
	
	public void cancelSearch(View view) {
		Intent intent = new Intent();
		setResult(AppConstat.XY_SEARCH_CANCEL_CODE, intent);
		finish();
	}
}
