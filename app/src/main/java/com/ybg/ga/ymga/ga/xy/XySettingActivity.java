 ...
 * 
 */
public class XySettingActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xy_setting);

		initView();

		Toolbar toolbar = (Toolbar) findViewById(R.id.xySettingToolbar);
	...
	private void initView() {
		...
		userBirthView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				new DatePickerDialog(XySettingActivity.this, userBirthListener,
