 ...
 *
 */
public class YdHistorySearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.yd_history_search);
		
		beginDateView = (EditText) findViewById(R.id.ydHistorySearchBegin);
		endDateView = (EditText) findViewById(R.id.ydHistorySearchEnd);
		...
		beginDateView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new DatePickerDialog(YdHistorySearchActivity.this, beginDateListener,
		...
		endDateView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				new DatePickerDialog(YdHistorySearchActivity.this, endDateListener,
						calendar.get(Calendar.YEAR), calendar
								.get(Calendar.MONTH), calendar
								.get(Calendar.DAY_OF_MONTH)).show();
			}
	...
	public void beginSearch(View view) {
		...
		setResult(AppConstat.YD_SEARCH_RESULT_CODE, intent);
		finish();
	}
	
	public void cancelSearch(View view) {
		Intent intent = new Intent();
		setResult(AppConstat.YD_SEARCH_CANCEL_CODE, intent);
		finish();
	}
