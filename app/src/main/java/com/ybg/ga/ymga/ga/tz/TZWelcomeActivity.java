...
public class TZWelcomeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tz_container);

		mPager = (ViewPager) findViewById(R.id.vPager);
		manager = new LocalActivityManager(this, true);
		manager.dispatchCreate(savedInstanceState);

		view0 = getIntentView("A", new Intent(TZWelcomeActivity.this,
				TZMainActivity.class));
		view1 = getIntentView("B", new Intent(TZWelcomeActivity.this,
				TZHistoryActivity.class));
		view2 = getIntentView("C", new Intent(TZWelcomeActivity.this,
				AboutActivity.class));

		InitViewPager();
		radioGroup = (RadioGroup) this.findViewById(R.id.tz_tab_btns);
		radioGroup
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 0:
				index = 0;
				radioGroup.check(R.id.tzMainTab);
				listViews.set(0, view0);
				mpAdapter.notifyDataSetChanged();
				break;
			case 1:
				index = 1;
				radioGroup.check(R.id.tzHistoryTab);
				listViews.set(1, view1);
				mpAdapter.notifyDataSetChanged();
				break;
			case 2:
				index = 2;
				radioGroup.check(R.id.tzDiscoverTab);
				listViews.set(2, view2);
				mpAdapter.notifyDataSetChanged();
				break;
			}
