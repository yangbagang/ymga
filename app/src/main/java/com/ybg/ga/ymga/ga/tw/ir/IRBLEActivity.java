 ...
 */
public class IRBLEActivity extends Activity {
    ...
    private boolean checkRight() {
        ...
        return ybgApp.checkPermission(IRBLEActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION,
    ...
    protected void onStart() {
        ...
        if (bluetoothAdapter == null) {
            ...
            // 开启后台程序
            bindService(new Intent(IRBLEActivity.this, IRDeviceService.class), irConnection, Context.BIND_AUTO_CREATE);
        }
        Intent bindIntent = new Intent(IRBLEActivity.this, TWDataService.class);
