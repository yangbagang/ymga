 ...
 */
public class TWWelcomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tw_container);

        mPager = (ViewPager) findViewById(R.id.vPager);
        manager = new LocalActivityManager(this, true);
        manager.dispatchCreate(savedInstanceState);

        view0 = getIntentView("A", new Intent(TWWelcomeActivity.this,
                TWMainActivity.class));
        view1 = getIntentView("B", new Intent(TWWelcomeActivity.this,
                TWHistoryActivity.class));
        view2 = getIntentView("C", new Intent(TWWelcomeActivity.this,
                TWQuShiActivity.class));

        InitViewPager();
        radioGroup = (RadioGroup) this.findViewById(R.id.tw_tab_btns);
        radioGroup
    ...
    public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            switch (arg0) {
                case 0:
                    index = 0;
                    radioGroup.check(R.id.twMainTab);
                    listViews.set(0, view0);
                    mpAdapter.notifyDataSetChanged();
                    break;
                case 1:
                    index = 1;
                    radioGroup.check(R.id.twHistoryTab);
                    listViews.set(1, view1);
                    mpAdapter.notifyDataSetChanged();
                    break;
                case 2:
                    index = 2;
                    radioGroup.check(R.id.twRecordTab);
                    listViews.set(2, view2);
                    mpAdapter.notifyDataSetChanged();
                    break;
            }
